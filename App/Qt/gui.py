...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableView_2 = QtWidgets.QTableView(self.flags_tab)
        ...
        self.columnView = QtWidgets.QColumnView(self.points_tab)
        self.columnView.setGeometry(QtCore.QRect(10, 10, 1051, 611))
